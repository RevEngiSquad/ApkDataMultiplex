...
import static org.revengi.zip.ZipConstant.*;
...
public class ZipFile implements Closeable {
    ...
    private long parseZip64EocdRecordLocator(long eocdOffset)
        ...
        // a zip64 locator and a zip64 eocd record is considered "empty". In our
        // implementation,
        // we parse all records and read the counts from them instead of drawing any
        // size or
    ...
    public InputStream getInputStream(ZipEntry ze) throws IOException {
        ...
        InputStream is = new BridgeInputStream(archive, start,
                method == METHOD_STORED ? ze.getSize() : ze.getCompressedSize());
        switch (method) {
