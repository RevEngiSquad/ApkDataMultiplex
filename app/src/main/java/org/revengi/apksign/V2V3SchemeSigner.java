...
import org.revengi.io.RandomAccessFactory;
import org.revengi.io.RandomAccessFile;
import org.revengi.apksign.data.ByteArrayDataSource;
import org.revengi.apksign.data.DataSource;
import org.revengi.apksign.data.DataSources;
import org.revengi.apksign.key.SignatureKey;
...
import static org.revengi.apksign.ByteArrayUtil.*;
...
public class V2V3SchemeSigner {
    ...
    public static void sign(File file, SignatureKey signatureKey, boolean enableV2, boolean enableV3) throws Exception {
        ...
        try (RandomAccessFile accessFile = RandomAccessFactory.from(file, "rw")) {
            ...
            int padSizeBeforeApkSigningBlock = getPaddingSize(zipBuffer.getEntriesDataSizeBytes(),
    ...
    private static List<SignatureAlgorithm> getSuggestedSignatureAlgorithms(PublicKey signingKey)
    ...
    private static byte[] encodePublicKey(PublicKey publicKey) throws InvalidKeyException, NoSuchAlgorithmException {
        ...
        try {
            encodedPublicKey = KeyFactory.getInstance(publicKey.getAlgorithm())
