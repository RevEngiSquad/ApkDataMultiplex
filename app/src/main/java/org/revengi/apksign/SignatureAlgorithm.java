...
import static org.revengi.apksign.ByteArrayUtil.setInt;
...
abstract class SignatureAlgorithm {
    ...
    static class BaseSignatureAlgorithm extends SignatureAlgorithm {
        ...
        BaseSignatureAlgorithm(int id, String digestAlgorithm, String keyAlgorithm, String signatureAlgorithm,
                AlgorithmParameterSpec signatureAlgorithmParams) {
            this.id = id;
        ...
        @Override
        public void computeDigest(DataSource beforeCentralDir, DataSource centralDir, DataSource eocd)
                throws Exception {
            ...
            int totalChunkSize = getChunkCount(beforeCentralDir.size()) + getChunkCount(centralDir.size())
    ...
    static class BaseVeritySignatureAlgorithm extends SignatureAlgorithm {
        ...
        BaseVeritySignatureAlgorithm(int id, String keyAlgorithm, String signatureAlgorithm,
                AlgorithmParameterSpec signatureAlgorithmParams) {
            this.id = id;
            this.keyAlgorithm = keyAlgorithm;
            this.signatureAlgorithm = signatureAlgorithm;
